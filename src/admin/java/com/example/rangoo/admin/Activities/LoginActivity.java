package com.example.rangoo.admin.Activities;
...
import com.example.rangoo.databinding.ActivityLoginAdminBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isAdminVariant = getPackageName().equals("com.example.rangoo.admin");
